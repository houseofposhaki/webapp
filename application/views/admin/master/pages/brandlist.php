				...
				<div class="card">
					...
					<div class="card-body">
						<div class="text-right mb-3">
							<a href="<?=base_url()?>admin/brandadd">
							...
							<tbody>
								...
								foreach($res as $row) { $i++; ?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url();?>admin/Adminnewcontroller/brandsave/<?=$row['id']?>">
												<i class="fas fa-edit"></i>
											</a>
										</td>
										<td>
											<a href="<?php echo base_url();?>admin/Adminnewcontroller/branddel/<?=$row['id']?>"
